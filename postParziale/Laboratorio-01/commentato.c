#include <stdio.h>      //libreria: per le operazioni di input e output
#include <stdlib.h>     //libreria: allocazione di memoria, controllo dei processi
#include <unistd.h>     //libreria: per le chiamate a sistema operativo basilari
#include <fcntl.h>      //libreria: per la definizione del tipo d'accesso ai file
